...
def collect_events(helper, ew):
    ...
    splunk_home = helper.get_global_setting('splunk_home')
    lookup = helper.get_arg('lookup')
    file_name=f'{splunk_home}/etc/apps/splunk_webcrawler/lookups/{lookup}'
    ...
    for d in data:
        ...
        try:
            ...
            result = f'product_name={d[1]}, inventory_count={inventory_count}'
            event = helper.new_event(result,time=None, host=None, index=None, source=None, sourcetype=None, done=True, unbroken=True)
            ew.write_event(event)
        except:
